...
* `target/DesktopPet.jar`
* `target/DesktopPet.exe`
* `target/DesktopPet_1.0.22.zip`
...
1. Extract `target/DesktopPet_1.0.22.zip` to a writable directory.
2. Start `DesktopPet.exe`. If launcher diagnostics are needed, run `java -jar DesktopPet.jar` from a terminal in the
